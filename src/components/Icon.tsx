const paths: Record<string, React.ReactNode> = {
  ...
  store: <><path d="M4 9h16l-1-4H5L4 9Z" /><path d="M5 9v11h14V9M9 20v-6h6v6" /></>,
...
export default function Icon({ name, className = "h-5 w-5", strokeWidth = 1.6 }: { name: keyof typeof paths | string; className?: string; strokeWidth?: number }) {
  return (
